...
namespace Licenta.Data.Migrations
{
    ...
    [Migration("20210525125452_ColumnRedirectToPageNotificariTable")]
    partial class ColumnRedirectToPageNotificariTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Licenta.Models.CereriDocumente.CerereDocument", b =>
                {
                    b.Property<int>("CerereDocumentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("AdeverintaPath")
                    ...
                    b.Property<string>("DenumireCerere")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DenumireClient")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TipCerereId")
                        .HasColumnType("int");

                    b.HasKey("CerereDocumentId");

                    b.HasIndex("ApplicationUserId");

                    b.ToTable("CereriDocumente");
                });

            modelBuilder.Entity("Licenta.Models.CereriDocumente.TipCerere", b =>
                {
                    b.Property<int>("TipCerereId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("TipCerereId");

                    b.HasIndex("CerereDocumentId");

                    b.ToTable("TipCereri");
                });

            modelBuilder.Entity("Licenta.Models.Chat.Chat", b =>
                {
            ...
            modelBuilder.Entity("Licenta.Models.Chat.ChatUser", b =>
                {
                    b.Property<int>("ChatId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Licenta.Models.Chat.Mesaj", b =>
                {
            ...
            modelBuilder.Entity("Licenta.Models.Notificari.Notificare", b =>
                {
                    ...
                    b.Property<string>("RedirectToPage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Licenta.Models.Notificari.NotificareUser", b =>
                {
                    ...
                    b.HasKey("NotificareId", "ApplicationUserId");

                    b.HasIndex("ApplicationUserId");

                    b.ToTable("NotificareUsers");
                });

            modelBuilder.Entity("Licenta.Models.Plati.Plata", b =>
                {
                    ...
                    b.Property<bool>("SuccesPlata")
                        .HasColumnType("bit");

                    b.Property<float>("Suma")
                        .HasColumnType("real");

                    b.Property<int>("TipPlataId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TipPlataId");

                    b.ToTable("Plati");
                });

            modelBuilder.Entity("Licenta.Models.Plati.TipPlata", b =>
                {
                    b.Property<int>("TipPlataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Licenta.Models.CereriDocumente.TipCerere", b =>
                {
                    b.HasOne("Licenta.Models.CereriDocumente.CerereDocument", null)
                        .WithMany("TipCerere")
                        .HasForeignKey("CerereDocumentId");
                });
            ...
            modelBuilder.Entity("Licenta.Models.Chat.ChatUser", b =>
                {
                    ...
                    b.HasOne("Licenta.Models.Chat.Chat", "Chat")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Licenta.Models.Notificari.NotificareUser", b =>
                {
                    ...
                    b.HasOne("Licenta.Models.Notificari.Notificare", "Notificare")
                        .WithMany("NotificareUsers")
            ...
            modelBuilder.Entity("Licenta.Models.Plati.Plata", b =>
                {
                    ...
                    b.HasOne("Licenta.Models.Plati.TipPlata", "TipPlata")
                        .WithMany()
                        .HasForeignKey("TipPlataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Client");

                    b.Navigation("TipPlata");
                });
